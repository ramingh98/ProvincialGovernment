...
namespace Common.Functions
{
    ...
    {
        public static AppConfig configuration = null;
        //===========================================================================
        public static string GetSmsApiKey()
        {
            return GetConfig().smsApiKey;
        }
        //===========================================================================
        public static string GetAppFilePath()
        {
            return GetConfig().appFilePath;
        }
        //===========================================================================
        ...
        //===========================================================================
        public static string GetZarinPalMerchantId()
        {
            return GetConfig().zarinPal_MerchantId;
        }
        //===========================================================================
        public static string GetSmsSenderLine()
        {
            return GetConfig().smsSenderLine;
        }
        //===========================================================================
        public static string GetPanelUrl()
        {
            return GetConfig().panelUrl;
        }
        //===========================================================================
        ...
        {
            return GetConfig().jwtTokenKey;
        }
        //===========================================================================
        public static string CdnUrl()
        {
            return GetConfig().cdnUrl;
        }
        //===========================================================================
        ...
        static AppConfig GetConfig()
        {
            ...
            {
                configuration = JsonConvert.DeserializeObject<AppConfig>(FileReader.ReadAsText(Directory.GetCurrentDirectory() + "\\appConfig.json"));
            }
